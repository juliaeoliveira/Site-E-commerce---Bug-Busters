...
export default function Tasks({ navigation }) {
    ...
    1: [
      {
        id: 1,
        name: "Vestido Floral",
        image: require("../../assets/images/pexels-daisatj-5062276.jpg"),
      },
      {
        id: 2,
        name: "Vestido Leve",
        image: require("../../assets/images/pexels-rnnzeravac-12573815.jpg"),
      },
      {
        id: 3,
        name: "Vestido Casual",
        image: require("../../assets/images/pexels-jonathanborba-30822468.jpg"),
      },
      {
        id: 4,
        name: "Vestido Solto",
  ...
  useEffect(() => {
    async function loadRealProducts() {
      ...
      for (const [collectionId, category] of Object.entries(
        ...
        try {
          ...
          console.log(
            `Categoria "${category}" não encontrada no banco, usando dados mockados`,
          );
        }
      }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.circlesContainer}>
        {collections.map((item) => (
          <TouchableOpacity
            key={item.id}
            style={[styles.circle, selected === item.id && styles.circleActive]}
